...
(cat << EOF) | sed s/__DEVICE__/$DEVICE/g > ../../../vendor/htc/bravo/BoardConfigVendor.mk
# Copyright (C) 2010 The Android Open Source Project
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
...
mkdir -p ../../../vendor/htc/bravo/overlay/packages/apps/Launcher2/res/layout
(cat << EOF) | sed s/__DEVICE__/$DEVICE/g > ../../../vendor/htc/bravo/overlay/packages/apps/Launcher2/res/layout/all_apps.xml
